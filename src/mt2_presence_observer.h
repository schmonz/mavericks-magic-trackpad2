#ifndef MT2_PRESENCE_OBSERVER_H
#define MT2_PRESENCE_OBSERVER_H
#include "mt2_presence.h"

/* Shared IOKit adapter over the pure mt2_presence SM: arms FirstMatch+Terminated notifications for the
 ...
 * truth, one place. This is the IOKit-bound half; the decision logic is the host-tested mt2_presence. */
...
typedef struct mt2_presence_observer mt2_presence_observer_t;
...
mt2_presence_observer_t *presence_observer_create(void *runloop /* CFRunLoopRef */,
                                                  int removal_ms,

#ifndef MAVERICKS_FRAME_H
#define MAVERICKS_FRAME_H
#include <stdint.h>
#include <stddef.h>
...
#define MAVERICKS_MAX_CONTACTS 16
#define MAX_TOUCHES MAVERICKS_MAX_CONTACTS   /* legacy alias, same value */
...
typedef struct {
     ...
     * element type is MavericksTouchContact (not a partial rename); see the header comment above. */
    MavericksTouchContact transducers[MAVERICKS_MAX_CONTACTS];
} MavericksTouchFrame;

...
/* Frame layout (matches Linux hid-magicmouse.c TRACKPAD2_BT_REPORT_ID, captured live
 * 2026-06-16): report id 0x31, 4-byte header, then N * 9-byte finger records. Identical
 * to the USB format (mt2_usb_decode) except the report id and the shorter header. */
#define MT2_REPORT_ID 0x31
#define MT2_HEADER    4
#define MT2_RECSZ     9

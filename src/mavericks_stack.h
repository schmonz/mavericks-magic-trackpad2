...
#define MAVERICKS_VT_getMultitouchReport       0xcc8  /* [BUILD] geometry DATA fetch                     */
#define MAVERICKS_VT_getMultitouchReportInfo   0xcd8  /* [BUILD] geometry LENGTH probe — runs FIRST in   */
                                                /*   _deviceGetReportWithLookUp; if it fails the   */
                                                /*   data fetch (0xcc8) is never reached.          */
#define MAVERICKS_VT_createMultitouchHandler   0xd08  /* [REF] spawns the AMD. UNVERIFIED this session   */
                                                /*   (from prior RE); re-confirm before relying.   */
#define MAVERICKS_VT_newTransportString        0x868  /* [BUILD] IOBluetoothHIDDriver::newTransportString;*/
...
#define MAVERICKS_AMD_setGetReportHandler      0x858
#define MAVERICKS_AMD_setReportInfoHandler     0x868
#define MAVERICKS_AMD_getReport                0x880
#define MAVERICKS_AMD_deviceGetReportWithLookUp 0x8e8
#define MAVERICKS_AMD_getFeatureReportInfo     0x8f8

/* ---- struct field offsets -------------------------------------------------------------------- */
#define MAVERICKS_OFF_BNB_AMD                  0x1b0  /* [BUILD] BNBDevice multitouch handler            */
                                               /*   (AppleMultitouchDevice*), set by              */
                                               /*   startMultitouchThreaded. re/xref-offset.      */
#define MAVERICKS_OFF_BNB_INTERRUPT_CHANNEL    0xf0   /* [BUILD] BNBDevice::_interruptChannel            */
#define MAVERICKS_OFF_L2CAP_DELEGATE_CB        0x110  /* [BUILD] IOBluetoothL2CAPChannel delegate cb     */
...
#define MAVERICKS_OFF_AMD_HANDLER_OBJ          0xa8   /* [REF] AMD getReport handler object; layout      */
...
/*       reads getProperty(MAVERICKS_PROP_EXTRACT_BUTTON)==true; without it handlePointerEventFromDevice */
...
#define MAVERICKS_PSM_INTERRUPT                0x13   /* PSM 19 interrupt channel (control = PSM 17 = 0x11) */
#define MAVERICKS_L2CAP_VT_listenAt            0xa50  /* IOBluetoothL2CAPChannel::listenAt(IOService*, cb)  */
#define MAVERICKS_L2CAP_VT_waitForChannelState 0xa20  /* ::waitForChannelState(state); arg 4 = OPEN         */
#define MAVERICKS_L2CAP_STATE_OPEN             4
#define MAVERICKS_HIDP_SET_PROTOCOL            0x70   /* SET_PROTOCOL transaction; |bit (0x70 boot/0x71     */
...
#define MAVERICKS_HIDP_SET_REPORT_FEATURE      0x53   /* [BUILD] (SET_REPORT<<4)|FEATURE — raw-L2CAP HIDP */
...
/* ---- report ids ------------------------------------------------------------------------------ */
#define MAVERICKS_REPORT_ID_MT2                0x31   /* MT2 multitouch report (see src/mt2_decode.c)    */
#define MAVERICKS_REPORT_ID_MT1                0x28   /* MT1 multitouch report (see src/mavericks_amd_terminal_encode.c)    */
...
#define MAVERICKS_PARSER_TYPE                  1000   /* [BUILD] selects the CompactV4 contact parser (both)*/
...
#define MAVERICKS_PARSER_OPTIONS_BT            0x2F   /* 47: BT's genuine value                             */
#define MAVERICKS_PARSER_OPTIONS_USB           0x27  /* 39: Apple's genuine USB-personality value          */
#define MAVERICKS_MTHID_PLUGIN_GUID            "0516B563-B15B-11DA-96EB-0014519758EF" /* IOCFPlugInTypes key */
#define MAVERICKS_MTHID_PLUGIN_PATH            "AppleMultitouchDriver.kext/Contents/PlugIns/MultitouchHID.plugin"
/* [BUILD] shared property keys, seeded identically on both transports (one spelling, no drift).    */
#define MAVERICKS_PROP_MTHID_DEVICE            "MTHIDDevice"
#define MAVERICKS_PROP_HID_SERVICE_SUPPORT     "HIDServiceSupport"
#define MAVERICKS_PROP_MOMENTUM_SCROLL         "TrackpadMomentumScroll"
#define MAVERICKS_PROP_SECONDARY_CLICK_CORNERS "TrackpadSecondaryClickCorners"
#define MAVERICKS_PROP_FOUR_FINGER_GESTURES    "TrackpadFourFingerGestures"
...
#define MAVERICKS_PROP_EXTRACT_BUTTON          "ExtractAndPostDeviceButtonState"

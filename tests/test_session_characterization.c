...
static void s1_button_edge(void) {
    ...
    MavericksTouchFrame f0 = contact(50, 20, 0);  mt2_session_frame(&s, USB, &f0, 5000, &k);
    MavericksTouchFrame f1 = contact(50, 20, 1);  mt2_session_frame(&s, USB, &f1, 5005, &k);
    MavericksTouchFrame f2 = contact(50, 20, 1);  mt2_session_frame(&s, USB, &f2, 5010, &k);
    MavericksTouchFrame f3 = contact(50, 20, 0);  mt2_session_frame(&s, USB, &f3, 5015, &k);

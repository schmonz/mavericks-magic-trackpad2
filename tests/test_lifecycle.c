...
static mt2_frame frame_of(int n, const int *ids) {
...
static int slot_of(const mt2_frame *f, int id) {
...
static void run_tests(void) {
    ...
    { mt2_lifecycle_t lc; mt2_lifecycle_reset(&lc);
      int ids[] = {3}; mt2_frame f = frame_of(1, ids);
    ...
    { mt2_lifecycle_t lc; mt2_lifecycle_reset(&lc);
      int ids[] = {3};
      mt2_frame f1 = frame_of(1, ids); mt2_lifecycle_step(&lc, &f1);
      mt2_frame f2 = frame_of(1, ids); mt2_lifecycle_step(&lc, &f2);
    ...
    { mt2_lifecycle_t lc; mt2_lifecycle_reset(&lc);
      int ids[] = {3};
      mt2_frame f1 = frame_of(1, ids); mt2_lifecycle_step(&lc, &f1);
      mt2_frame gone; memset(&gone, 0, sizeof gone);   /* no present contacts */
      ...
      mt2_frame gone2; memset(&gone2, 0, sizeof gone2);
    ...
    { mt2_lifecycle_t lc; mt2_lifecycle_reset(&lc);
      int ids2[] = {1, 4}; mt2_frame f1 = frame_of(2, ids2); mt2_lifecycle_step(&lc, &f1);
      int ids1[] = {1};    mt2_frame f2 = frame_of(1, ids1); mt2_lifecycle_step(&lc, &f2);
    ...
    { mt2_lifecycle_t lc; mt2_lifecycle_reset(&lc);
      int ids1[] = {1};        mt2_frame f1 = frame_of(1, ids1); mt2_lifecycle_step(&lc, &f1);
      int ids2[] = {1, 4};     mt2_frame f2 = frame_of(2, ids2); mt2_lifecycle_step(&lc, &f2);
      int s1 = slot_of(&f2, 1), s4 = slot_of(&f2, 4);
      CHECK_EQ(f2.transducers[s1].state, TS_TOUCHING);
    ...
    { mt2_lifecycle_t lc; mt2_lifecycle_reset(&lc);
      int ids[] = {3};
      mt2_frame f1 = frame_of(1, ids); mt2_lifecycle_step(&lc, &f1);
      mt2_frame gone; memset(&gone, 0, sizeof gone); mt2_lifecycle_step(&lc, &gone);
      mt2_frame f2 = frame_of(1, ids); mt2_lifecycle_step(&lc, &f2);
    ...
    { mt2_lifecycle_t lc; mt2_lifecycle_reset(&lc);
      ...
      mt2_frame f2; memset(&f2, 0, sizeof f2);
    ...
    { mt2_lifecycle_t lc; mt2_lifecycle_reset(&lc);
      int ids2[] = {2, 5}; mt2_frame f1 = frame_of(2, ids2); mt2_lifecycle_step(&lc, &f1);
      mt2_frame out; int any = mt2_lifecycle_flush(&lc, &out);
      CHECK_EQ(any, 1);
      ...
      mt2_frame out2; CHECK_EQ(mt2_lifecycle_flush(&lc, &out2), 0); }

    /* flush with nothing active returns 0. */
    { mt2_lifecycle_t lc; mt2_lifecycle_reset(&lc);
      mt2_frame out; CHECK_EQ(mt2_lifecycle_flush(&lc, &out), 0); }

    /* reset() forgets history: no pending end, next contact is new. */
    { mt2_lifecycle_t lc; mt2_lifecycle_reset(&lc);
      int ids[] = {2}; mt2_frame f1 = frame_of(1, ids); mt2_lifecycle_step(&lc, &f1);
      mt2_lifecycle_reset(&lc);
      mt2_frame out; CHECK_EQ(mt2_lifecycle_flush(&lc, &out), 0);   /* nothing pending */
      mt2_frame f2 = frame_of(1, ids); mt2_lifecycle_step(&lc, &f2);
      CHECK_EQ(f2.transducers[0].state, TS_START); }
}
TEST_MAIN()
